...
每天北京时间 07:30 从公开网页和 RSS 筛选 A 股、港股、美股、基金/ETF及相关全球宏观资讯，更新 GitHub Pages，并向飞书群推送 1 张含五个折叠板块的原生卡片。A股、港股、股票、基金和 ETF 五个板块各展示最多 10 条，一条资讯可以进入多个相关板块。全程不调用付费 AI API。
